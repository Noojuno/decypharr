...
class ConfigManager {
    ...
    collectFormData() {
        return {
            ...
            auto_promote: document.querySelector('[name="auto_promote"]')?.checked || false,
            local_files_path: document.querySelector('[name="local_files_path"]')?.value || "",
